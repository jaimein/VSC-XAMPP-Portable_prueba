...
#!perl
#line 29
    eval 'exec \Users\jaime\OneDrive\Escritorio\portable\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\jaime\OneDrive\Escritorio\portable\xampp\perl\bin\perl.exe';
